...
def main():
    ...
    print()
    # 集計の中身を変えていなくても差異が出る要因が2つある。どちらもコードの
    # 不具合ではないため、先に切り分けられるよう明示しておく。
    print("次の場合は、コードを変えていなくても差異が出ます。")
    print("  ・収集によって対戦数が増えたとき")
    print("  ・7d / 30d の期間は現在時刻を基準にするため、時間の経過で対象がずれたとき")
    print("    （差異が 7d や 30d の組だけに出ているなら、まずこれを疑う）")
